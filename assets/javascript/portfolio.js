// this is hell, ignore this mess

'use strict';

// ignore for now: const ipgeolocation = 'https://api.ipgeolocation.io/ipgeo?apiKey=';
...
$(document).ready(() => {
  ...
  for (let i in links) {
    ...
    $('#marquee').append(`<a href="https://instagram.com/${link.link}/" target="_BLANK">${link.name}</a>`);

    link = $('#marquee').children('a').last();

    if (i != links.length - 1) $('#marquee').append(' <img class="emoticon" src="assets/others/blank.png"> ');
  }
  ...
  // app.titleChanger(['wintersunset']);
  // app.iconChanger(['assets/icons/icon.ico']); moved to html
});
